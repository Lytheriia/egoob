...
namespace Content.Server._Funky.Stains;

public sealed partial class StainableSystem : SharedStainableSystem
{
    [Dependency] private readonly ForensicsSystem _forensics = default!;
    [Dependency] private readonly ForensicScannerSystem _forensicScanner = default!;
    ...
    {
        _tag.AddTag(ent.Owner, _forensicScanner.GetDNASolutionScannableTag());
    }
