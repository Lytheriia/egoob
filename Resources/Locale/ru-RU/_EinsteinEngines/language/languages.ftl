...
language-Hydraspeak-description =
    Этот необычный язык состоит из смеси щебета, переливов и чириканья с сильными тональными и высотными сдвигами.
    Из-за птичьей природы гидракинов одно слово может означать миллион других вещей одновременно, что делает этот язык почти непонятным даже для других птицеподобных рас.

language-Hydraspeak-name = Ги'дран'ский

chat-language-Demonic-name = Каршаниль
...
chat-language-Shark-name = Эве-Пишту
language-Shark-name = Эве-Пишту
language-Shark-description =
    Эве-Пишту очень занимательный язык плафеимов.
    Состоит он в основном из коротких, глухих и некоторых шипящих звуков,
    а так же из-за схожести языка с "Синта-Унати", некоторые представители вида могут говорить и на нём.
